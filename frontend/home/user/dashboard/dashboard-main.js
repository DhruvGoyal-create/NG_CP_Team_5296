...
function setupRealTimeUpdates() {
    ...
    transactionManager.onTransactionEvent('transactionAdded', function(transaction) {
        console.log('New transaction added, updating dashboard:', transaction);
        updateDashboardSummary();
        showNotification('New transaction added to dashboard!', 'success');
    });
    
    transactionManager.onTransactionEvent('transactionUpdated', function(transaction) {
        console.log('Transaction updated, refreshing dashboard:', transaction);
        updateDashboardSummary();
        showNotification('Transaction updated on dashboard!', 'info');
    });
    
    transactionManager.onTransactionEvent('transactionDeleted', function(transactionId) {
        console.log('Transaction deleted, updating dashboard:', transactionId);
        updateDashboardSummary();
        showNotification('Transaction deleted from dashboard!', 'warning');
    });
}
